...
const academic_calender = `CREATE TABLE academic_calendars (
    ...
    UNIQUE(college_id, academic_session) -- No college can make 2 calender for the same year. Insted college has to delete existing to create
);`
...
// // Real logic
const specific_date = `CREATE TABLE calendar_day_exception (
   ...
   day_status day_status_enum NOT NULL,
    ...
    -- It is removed because user may give wrong day -> specific_day day_of_week NOT NULL,

    reason TEXT,
    -- Removed as college can only do -> created_by UUID REFERENCES users(user_id),
